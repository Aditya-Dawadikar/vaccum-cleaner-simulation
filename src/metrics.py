...
def evaluate_simulation(environment:Environment, agent:Agent, verbose=False)->dict:
    ...
    percentage_dirt_cleaned = round(((initial_dirt_count-final_dirt_count)/initial_dirt_count)*100,2)
